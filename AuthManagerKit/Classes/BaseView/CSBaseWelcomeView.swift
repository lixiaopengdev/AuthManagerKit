...
public class CSBaseWelcomeView: CSAuthBaseView {
    ...
    func createBackView() {
        ...
        startButton.snp.makeConstraints { make in
            ...
            make.centerX.equalToSuperview()           // 横向居中
            make.bottom.equalTo(self.orLabel.snp.top).offset(-10)  // 距底部 184 点
        }
...
//            make.centerY.equalTo(orLabel.snp.bottom).offset(10)
    ...
    private lazy var startButton: UIButton = {
        let button = UIButton()
        button.setBackgroundImage(UIImage.bundleImage(named: "start_back_icon"), for: .normal)
    ...
    private lazy var discordButton: UIButton = {
        let button = UIButton()
        button.setBackgroundImage(UIImage.bundleImage(named: "discord_back_icon"), for: .normal)
    ...
    private lazy var appleButton: UIButton = {
        let button = UIButton()
        button.setBackgroundImage(UIImage.bundleImage(named: "apple_back_icon"), for: .normal)
