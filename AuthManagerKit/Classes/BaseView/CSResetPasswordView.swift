...
class DetailView: UIView {
    ...
    public func setState(state: Bool) {
        if state {
            self.checkButton.setImage(UIImage.bundleImage(named: "mini_icon_s"), for: .normal)
            self.detailLabel.textColor = .cs_green
        } else {
            self.checkButton.setImage(UIImage.bundleImage(named: "mini_icon_error"), for: .normal)
